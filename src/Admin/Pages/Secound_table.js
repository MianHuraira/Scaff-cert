...
const TableSecound = ({ data, columns }) => {
  // ** State
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      containerClassName={
        "pagination  react-paginate pagination-sm d-flex align-items-center paginat justify-content-end  mt-1"
      }
    />
  );
